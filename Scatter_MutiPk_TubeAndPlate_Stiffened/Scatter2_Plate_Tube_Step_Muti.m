...
Ang_S=[0,0,0,0,0,0];                                                               
H_S=[0.0001,0.0001,0.0001,0.0001,0.00015,0.00015];
...
[Ki_Fp_S,Ki_Bp_S,Ki_Fc_S,Ki_Bc_S,Vis_Fp_U_S,Vis_Fp_V_S,Vis_Fp_W_S,Vis_Bp_U_S,Vis_Bp_V_S,Vis_Bp_W_S,Vis_Bc_U_S,Vis_Bc_V_S,Vis_Bc_W_S,Vis_Fc_U_S,Vis_Fc_V_S,Vis_Fc_W_S...
    ...
    ,Force_Bc_xx_S,Force_Bc_yy_S,Force_Bc_zz_S,Force_Bc_yz_S,Force_Bc_xz_S,Force_Bc_xy_S]=Get_AcousticField_ByMutiLayer_Tube(MaxLayers,N,Rr,Cons,Frequency_Input,Layer_S,Ang_S,H_S,Cut_S);  
