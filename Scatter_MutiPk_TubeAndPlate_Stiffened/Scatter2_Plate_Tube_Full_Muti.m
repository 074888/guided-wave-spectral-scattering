...
%--------------- ===============*    
%--------------- ===============*         
%   1Plate      3Tube           *    Muti layer
%--------------- ===============*
%----------------===============*
%% -----------------0.9e6:0.05e6:2.5e6;
Frequency_Loop=0.25e6:0.25e6:0.25e6;
Count=1;
...
[Ki_Fp_L,Ki_Bp_L,Ki_Fc_L,Ki_Bc_L,Vis_Fp_U_L,Vis_Fp_V_L,Vis_Fp_W_L,Vis_Bp_U_L,Vis_Bp_V_L,Vis_Bp_W_L,Vis_Bc_U_L,Vis_Bc_V_L,Vis_Bc_W_L,Vis_Fc_U_L,Vis_Fc_V_L,Vis_Fc_W_L...
    ...
    ,Force_Bc_xx_L,Force_Bc_yy_L,Force_Bc_zz_L,Force_Bc_yz_L,Force_Bc_xz_L,Force_Bc_xy_L]=Get_AcousticField_ByMutiLayer(MaxLayers,N,Cons,Frequency_Input,Layer_L,Ang_L,PkPhiy,H_L,Cut_L);
%% Get SingleLayers
[Ki_Fp_R,Ki_Bp_R,Ki_Fc_R,Ki_Bc_R,Vis_Fp_U_R,Vis_Fp_V_R,Vis_Fp_W_R,Vis_Bp_U_R,Vis_Bp_V_R,Vis_Bp_W_R,Vis_Bc_U_R,Vis_Bc_V_R,Vis_Bc_W_R,Vis_Fc_U_R,Vis_Fc_V_R,Vis_Fc_W_R...
    ...
    ,Force_Bc_xx_R,Force_Bc_yy_R,Force_Bc_zz_R,Force_Bc_yz_R,Force_Bc_xz_R,Force_Bc_xy_R]=Get_AcousticField_ByMutiLayer_Tube(MaxLayers,N,Rr,Cons,Frequency_Input,Layer_R,Ang_R,H_R,Cut_R);  

%% GetAll Ori-Acoustic Field
%Normalizations-JAll:MutiLayers
[J1,JAll_Fp_L]=Normalize_M(Line_L,N,H_L,Vis_Fp_U_L,Vis_Fp_V_L,Vis_Fp_W_L,Force_Fp_xx_L,Force_Fp_xy_L,Force_Fp_xz_L);
[J2,JAll_Bp_L]=Normalize_M(Line_L,N,H_L,Vis_Bp_U_L,Vis_Bp_V_L,Vis_Bp_W_L,Force_Bp_xx_L,Force_Bp_xy_L,Force_Bp_xz_L);

[J3,JAll_Fc_L]=Normalize_M(Line_L,N,H_L,Vis_Fc_U_L,Vis_Fc_V_L,Vis_Fc_W_L,Force_Fc_xx_L,Force_Fc_xy_L,Force_Fc_xz_L);
[J4,JAll_Bc_L]=Normalize_M(Line_L,N,H_L,Vis_Bc_U_L,Vis_Bc_V_L,Vis_Bc_W_L,Force_Bc_xx_L,Force_Bc_xy_L,Force_Bc_xz_L);

%----------------------------------------------------------------------------------------------------------------
[J5,JAll_Fp_R]=Normalize_M(Line_R,N,H_R,Vis_Fp_U_R,Vis_Fp_V_R,Vis_Fp_W_R,Force_Fp_xx_R,Force_Fp_xy_R,Force_Fp_xz_R);
[J6,JAll_Bp_R]=Normalize_M(Line_R,N,H_R,Vis_Bp_U_R,Vis_Bp_V_R,Vis_Bp_W_R,Force_Bp_xx_R,Force_Bp_xy_R,Force_Bp_xz_R);

[J7,JAll_Fc_R]=Normalize_M(Line_R,N,H_R,Vis_Fc_U_R,Vis_Fc_V_R,Vis_Fc_W_R,Force_Fc_xx_R,Force_Fc_xy_R,Force_Fc_xz_R);
[J8,JAll_Bc_R]=Normalize_M(Line_R,N,H_R,Vis_Bc_U_R,Vis_Bc_V_R,Vis_Bc_W_R,Force_Bc_xx_R,Force_Bc_xy_R,Force_Bc_xz_R);
