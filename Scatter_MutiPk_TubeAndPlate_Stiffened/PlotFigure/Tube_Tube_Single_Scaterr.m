...
tic
%% ----------------
[SteelAlloy1020,AlumiuumAlloy110,Oak,GRERokhlin2011,Steel,Tungsten,Tai,Graphite0,GRERokhlin2011_90,Graphepoxy,~,Unname...
    ,IsoPlate]=LoadDefualMaterial;                                                                                   %Load Materials
...
Me10=Graphepoxy;Me11=Unname;Me12=IsoPlate;

% --------------*===============*        
%---------------*               *           
%-------1Tube --*     2Tube     *     Single Layer   
%---------------*               *      
%---------------*===============*  
%---------------                    
%---------------                    
...
StifPhy_S=0;
h=0.001;
S_cut=0.5; %Get 1/Line_S EigenValues
%% --------------------------------
...
[Ki_Fp_M,Ki_Bp_M,Ki_Fc_M,Ki_Bc_M,Vis_Fp_U_M,Vis_Fp_V_M,Vis_Fp_W_M,Vis_Bp_U_M,Vis_Bp_V_M,Vis_Bp_W_M,Vis_Bc_U_M,Vis_Bc_V_M,Vis_Bc_W_M,Vis_Fc_U_M,Vis_Fc_V_M,Vis_Fc_W_M...
    ...
    ,Force_Bc_xx_M,Force_Bc_yy_M,Force_Bc_zz_M,Force_Bc_yz_M,Force_Bc_xz_M,Force_Bc_xy_M]=Get_AcousticField_ByMutiLayer_Tube(MaxLayers,N,Rr,Consz,Frequency_Input,Layers,Ang,H,M_cut); 
%% Get SingleLayers
[Ki_Fp_S,Ki_Bp_S,Ki_Fc_S,Ki_Bc_S,Vis_Fp_U_S,Vis_Fp_V_S,Vis_Fp_W_S,Vis_Bp_U_S,Vis_Bp_V_S,Vis_Bp_W_S,Vis_Bc_U_S,Vis_Bc_V_S,Vis_Bc_W_S,Vis_Fc_U_S,Vis_Fc_V_S,Vis_Fc_W_S...
    ...
    ,Force_Bc_xx_S,Force_Bc_yy_S,Force_Bc_zz_S,Force_Bc_yz_S,Force_Bc_xz_S,Force_Bc_xy_S]=Get_AcousticField_BySingle_Tube(N,Rr,Consz,Frequency_Input,Layer,StifPhy_S,h,S_cut);
