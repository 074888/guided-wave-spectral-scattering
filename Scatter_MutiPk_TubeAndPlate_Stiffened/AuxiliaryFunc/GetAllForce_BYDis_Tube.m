function [Force_Bp_xx,Force_Bp_yy,Force_Bp_zz,Force_Bp_yz,Force_Bp_xz,Force_Bp_xy]=GetAllForce_BYDis_Tube(Rr,N,Line,Cons,H,Ang,stiff,Ki_Bp,Vis_Bp_U,Vis_Bp_V,Vis_Bp_W)
%% ----------
...
%       Stiffness=stiff;                                                                                                  %Set Single thicness Stiffness；
        ...
        [Force_xx,Force_yy,Force_zz,Force_yz,Force_xz,Force_xy]=GetForce_ByDis_Tube(Lo,Rr,U,V,W,N,H,Cons,Stiffness,Ki_Bp);                   %Get Single layer Force
